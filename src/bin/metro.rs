...
fn main() {
    ...
    opts.optopt("A", "amplitude", "Amplitude of beep", "");
    opts.optopt("b", "bpm", "Bpm of beep", "");
    opts.optopt("d", "decay", "Decay (in percent of duration)", "");
    opts.optopt("D", "duration", "Duration of beep", "");
    opts.optopt("f", "frequency", "Frequency of beep", "");
    opts.optflag("t", "transport", "Transport aware");
